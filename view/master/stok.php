            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped text-center" id="stok">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Menu</th>
...
<?php include '../modal/stokModal.php'; ?>
<?php include '../layout/footer.php'; ?>
<script src="../../public/js/stokNav.js"></script>
<script src="../../aksi/stok.js"></script>
