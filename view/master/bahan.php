            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped text-center" id="bahan">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
...
<?php include '../modal/bahanModal.php'; ?>
<?php include '../layout/footer.php'; ?>
<script src="../../public/js/bahanNav.js"></script>
<script src="../../aksi/bahan.js"></script>
